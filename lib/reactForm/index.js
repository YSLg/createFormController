...
const From = (props) => {
    ...
    return (react_1.default.createElement("div", null, rule.map((item) => {
        return (react_1.default.createElement(Field, { key: item.field, conponents: conponents, form: form, ...item }));
    })));
};
