...
var reducer = function (state, _a) {
    ...
    switch (type) {
        ...
        case const_1.UPDATEUPFOCUSSTATUS:
            return __assign(__assign({}, state), (_e = {}, _e[Object.keys(payload)[0]] = __assign(__assign({}, state[Object.keys(payload)[0]]), { focusStatus: payload[Object.keys(payload)[0]] }), _e));
        case const_1.UPDATEUPDISABLED:
            return __assign(__assign({}, state), (_f = {}, _f[Object.keys(payload)[0]] = __assign(__assign({}, state[Object.keys(payload)[0]]), { disabled: payload[Object.keys(payload)[0]] }), _f));
    }
};
